     ...
     */
	    public void updateTask()
	    {
	    	...
	    	case 1:
	    		...
	    		//sleep.stop();
	    		sleep=new Sleep(attacker,2);
	    		sleep.setTarget(entityTarget);

	    		sleep.start();
	    		//attacker.addPotionEffect(inv);
	    		//attacker.removePotionEffect(14);
	    		sleep.setEstado(2);
	    		break;
	    	case 2:
	    	...
	    	case 3:
	    		//attacker.removePotionEffect(14);
	    		System.out.println(attacker.isEntityInvulnerable());
	    		attacker.moveSpeed=0.5f;
	    		sleep.setEstado(0);
	    		break;
	    	default:break;
	    	}
