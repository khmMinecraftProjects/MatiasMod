...
public class Base {
	...
	public void init(FMLInitializationEvent event)
	{
		...
		Fire = new ItemMatiasFire(558);
		String lan=StringTranslate.getInstance().currentLanguage;
		if(lan=="es_ES"){
			GameRegistry.registerItem(Fire, "Mechero de Matias");
		}else{
			GameRegistry.registerItem(Fire, "flint and Steel of Matias");
		}
		GameRegistry.addRecipe(new ItemStack(Fire, 1), new Object[] { 
		 ...
		 LanguageRegistry.addName(Fire,
				 "flint and Steel of Matias");
